(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_26782b._.js", {
...
function usePropertiesService() {
    return {
        ...
        async getByZone (publisherId, minLatitude, maxLatitude, minLongitude, maxLongitude) {
...
function PropertiesMap({ markers }) {
    ...
    const { isPending, isError, data, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const data = await pinService.getByZone(6, minLat, maxLat, minLng, maxLng);
            setFetchedBounds(bounds);
            setPins(data);
            const propertiesData = await propertiesService.getByZone(6, minLat, maxLat, minLng, maxLng);
...
//# sourceMappingURL=_26782b._.js.map